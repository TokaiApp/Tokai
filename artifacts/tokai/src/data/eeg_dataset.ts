...
// ── Real STEW subjects (generated by scripts/process_stew.py) ────────────────

import rawStew from "./stew_processed.json";
const realSubjects = rawStew as unknown as DatasetSubject[];

// ── Active export
export const eegDataset: DatasetSubject[] = realSubjects;
